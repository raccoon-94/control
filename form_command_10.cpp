...
#include "ui_form_command_10.h"

form_command_10::form_command_10(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::form_command_10)
{
    ui->setupUi(this);
...
form_command_10::~form_command_10()
{
    delete ui;
}

void form_command_10::update_form(){
    ...
    if(ui->radioButton_12->isChecked() == true){
        QByteArray t_c = QByteArray::fromHex(ui->lineEdit_8->text().toLatin1());
    ...
    if(ui->radioButton_11->isChecked() == true){
        QByteArray s_n = QByteArray::fromHex(ui->lineEdit_6->text().toLatin1());
...
void form_command_10::on_pushButton_2_clicked()
{
    this->close();
}

void form_command_10::on_pushButton_clicked()
{
    emit sendData_10(password,number_sorm,number_control,type_control,sign_number,number,number_tract);
}




void form_command_10::on_toolButton_clicked()
{
    clipboard->setText(ui->lineEdit_7->text());
}

void form_command_10::keyPressEvent(QKeyEvent* event)
{
